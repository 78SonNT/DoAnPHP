...
switch ($actual_link) {
  case '/localhost/DoAnPHP/index.php':
    $_SESSION['title'] = 'Shop Laptop cũ ';
    break;
  case '/DoAnPHP/shop.php':
    $_SESSION['title'] = 'Tất cả Sản Phẩm';
    break;
  case '/DoAnPHP/cart.php':
    $_SESSION['title'] = 'Giỏ Hàng Của Bạn';
    break;
  case '/DoAnPHP/checkout.php':
    $_SESSION['title'] = 'Check out';
    break;
  case '/DoAnPHP/single-product.php':
    $_SESSION['title'] = 'Chi tiết Sản Phẩm';
    break;
  case '/DoAnPHP/checkout.php':
    $_SESSION['title'] = 'Check out';
    break;
  case '/DoAnPHP/category.php':
    $_SESSION['title'] = 'Danh mục Sản Phẩm';
    break;
  case '/DoAnPHP/brand.php':
    $_SESSION['title'] = 'Thương hiệu';
    break;
  case '/DoAnPHP/orders.php':
...
<head>
  ...
  <link rel="icon" href="inc/faicon.png">
