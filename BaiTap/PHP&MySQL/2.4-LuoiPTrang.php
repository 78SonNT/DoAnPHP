...
<body>
    ...
    if ($numRows != 0) {
        ...
        echo "<div id='mid'>";
        //first page
        echo "<a href = '" . $_SERVER["PHP_SELF"] . "'?page=1' class ='btn-primary'><<</a>";
        //next page
        if ($_GET["page"] < $maxPage) {
            echo "<a href = '" . $_SERVER["PHP_SELF"] . "?page=" . $_GET["page"] + 1 . "' class ='btn-primary'><</a>";
        }
        ...
        //last page
        echo "<a href= '" . $_SERVER["PHP_SELF"] . "?page=" . $maxPage . "' class='btn-primary'>>></a>";
