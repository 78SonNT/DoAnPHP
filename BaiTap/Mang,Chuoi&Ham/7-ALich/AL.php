...
<body>
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            $mang_hinh=array("hoi.jpg","ty.jpg","suu.png","dan.jpg","mao.png","thin.jpg","t!.jpg","ngo.jpg","mui.jpg","than.jpg","dau.jpg","tuat.jpg");
            $nam_dl = $_POST['nam'];
            if(is_numeric($nam_dl) && is_int($nam_dl+0)){
                ...
                $hinh = $mang_hinh[$chi];
                $hinh_anh = "<img width='250px' height='200px' src='img/$hinh'>";
            }
        }
    ?>

    <form  action="" method="post">
        <table bgcolor="#FF6600" align="center" style="border:1px solid black;">
            <tr bgcolor="#006600" >
