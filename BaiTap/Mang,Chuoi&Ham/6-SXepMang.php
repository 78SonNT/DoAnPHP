    ...
    <form method="POST" action="">
        <center>
            <table bgcolor="#99FF99">
                ...
                <tr>
                    <td>Nhập mảng:</td>
                    <td style="color:red"><input size=40px name="ds" type="text" value="<?php if(isset($DS)) echo $DS;?>" required> <b>(*)</b></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                ...
                <tr>
                    <td colspan=2 style="color:red"><center><b>(*)</b><span style="color:black"> Các số được nhập cách nhau bởi dấu ","</span></center></td>
                </tr>
            </table>
        </center>
    </form>
